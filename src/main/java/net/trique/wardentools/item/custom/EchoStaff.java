    ...
    private void spawnSonicBoom(World world, LivingEntity user) {
        ...
        for (Entity hitTarget : hit) {
            if(hitTarget instanceof LivingEntity living) {
                ...
                double vertical = 1.0 * (1.0 - living.getAttributeValue(EntityAttributes.GENERIC_KNOCKBACK_RESISTANCE));
                double horizontal = 5.0 * (1.0 - living.getAttributeValue(EntityAttributes.GENERIC_KNOCKBACK_RESISTANCE));
