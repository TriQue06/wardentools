...
public class EnderSonicBoomParticle extends ExplosionLargeParticle {
    protected EnderSonicBoomParticle(ClientWorld world, double x, double y, double z, double velocity, SpriteProvider spriteProvider) {
